...
//class MovieFavoriteAdapter: PagedListAdapter<Film, MovieFavoriteAdapter.ListViewHolderMovieFavorite>(DIFF_CALLBACK) {
//    companion object{
...
//    }
//
//    inner class ListViewHolderMovieFavorite(private val binding: ItemRowFilmBinding) : RecyclerView.ViewHolder(binding.root){
//        fun bind(film: Film){
//
//            with(binding){
...
//    }
//
//    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolderMovieFavorite {
//        val binding = ItemRowFilmBinding.inflate(LayoutInflater.from(parent.context), parent, false)
//        return ListViewHolderMovieFavorite(binding)
//    }
//
//    override fun onBindViewHolder(holder: ListViewHolderMovieFavorite, position: Int) {
