...
//class FilmRepository private constructor(private val remoteDataSourceFilm: RemoteDataSourceFilm) : FilmDataSource {
//
//    companion object{
//        @Volatile
//        private var instance: FilmRepository?= null
//        fun getInstance (remoteDataSourceFilm: RemoteDataSourceFilm): FilmRepository = instance ?: synchronized(this){
//            FilmRepository(remoteDataSourceFilm).apply {
//                instance = this
//            }
//        }
//    }
...
class FilmRepository private constructor(
    ...
    companion object{
        ...
        fun getInstance (remoteDataSourceFilm: RemoteDataSourceFilm, localData: LocalDataSource, appExecutors: AppExecutors): FilmRepository = instance ?: synchronized(this){
            FilmRepository(remoteDataSourceFilm, localData, appExecutors).apply {
                instance = this
            }
        }
    }
...
//        return object : NetworkBoundResource<List<Film>, List<MovieResponse>>(appExecutors) {
//
//            public override fun loadFormDB(): LiveData<List<Film>> =
...
//    }
    ...
    //tv
//    override fun getAllTv(): LiveData<Resource<List<Film>>> {
//        return object : NetworkBoundResource<List<Film>, List<TvResponse>>(appExecutors) {
//
//            public override fun loadFormDB(): LiveData<List<Film>> =
...
//    }
    ...
    //get favorite
//    override fun getFavoriteMovie(): LiveData<List<Film>> =
//        localDataSource.getFavoriteMovies()
//
//    override fun getFavoriteTvSeries(): LiveData<List<Film>> =
