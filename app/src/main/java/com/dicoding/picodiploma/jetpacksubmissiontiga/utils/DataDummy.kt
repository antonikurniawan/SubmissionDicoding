...
object DataDummy {
    ...
    fun generateDummyMovie(): List<Film>{
    ...
    fun generateRemoteDummyTvSeries(): List<TvResponse>{
    ...
    fun generateSingleDummyMovie(): Film {
        return generateDummyMovie()[0]
    }

    fun generateSingleDummyTvSeries(): Film {
        return generateDummyTvSeries()[0]
    }
}